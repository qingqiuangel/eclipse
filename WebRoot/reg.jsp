	...
	<div id="list">
		 ...
		 <div class="list_info">
			 ...
			 <table class="regTable">
				...
				<tr>
					<td align="right" width="20%">用户头像：</td>
					<td align="left" width="80%">
					 <input type="radio" id="photo01" name="params.user_photo" value="01.gif" checked="checked"/>
		             <img src="images/head/01.gif" width="50" />
		             <input type="radio" id="photo02" name="params.user_photo" value="02.gif"/>
		             <img src="images/head/02.gif" width="50" />
		             <input type="radio" id="photo03" name="params.user_photo" value="03.gif"/>
		             <img src="images/head/03.gif" width="50" />
		             <input type="radio" id="photo04" name="params.user_photo" value="04.gif"/>
		             <img src="images/head/04.gif" width="50" />
		             <input type="radio" id="photo05" name="params.user_photo" value="05.gif"/>
		             <img src="images/head/05.gif" width="50" />
		             <input type="radio" id="photo06" name="params.user_photo" value="06.gif"/>

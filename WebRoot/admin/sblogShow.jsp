...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">帖子管理&gt;&gt;帖子查询</span>
</div>
  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <input type="text" id="paramsSblog.sblog_title" name="paramsSblog.sblog_title" value="${paramsSblog.sblog_title}" class="inputstyle"/>&nbsp;
            帖子类型：
      <s:select name="paramsSblog.sblog_type" id="paramsSblog.sblog_type" list="#{'1':'公司', '2':'校园', '3':'家庭', '4':'恋爱', '5':'日常'}"
      			value="%{#attr.paramsSblog.sblog_type}" listKey="key" listValue="value" headerKey="0" headerValue="请选择" 
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#sblog.nick_name"/></td>
   ...
   <s:else>
   <tr>
     <td height="60" colspan="6" align="center"><b>&lt;不存在帖子信息&gt;</b></td>
   </tr>
   </s:else>

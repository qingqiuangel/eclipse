...
public class UserDao {
	...
	public int addUser(User user, Connection conn){
		String sql = "INSERT INTO user(user_id,user_name,user_pass,user_mail,nick_name,real_name,user_sex,user_age,user_score,user_level,user_photo,reg_date,user_type) values(null,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public int updateUser(User user, Connection conn){
		...
		if (user.getUser_score()!=0) {
			sBuilder.append(" ,user_score =" + user.getUser_score() +" ");
		}
		if (user.getUser_level()!=0) {
